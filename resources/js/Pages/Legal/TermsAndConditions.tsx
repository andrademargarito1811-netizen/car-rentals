...
export default function TermsAndConditions({ document: legalDocument }: { document?: LegalDocument | null }) {
    useEffect(() => {
    ...
    const title = legalDocument?.title || 'Terms and Conditions';
    const subtitle = legalDocument?.subtitle || 'The terms and conditions governing the use of our website and services.';
