...
const raw: Array<[string, string]> = [
    ...
    ['HK', 'Hong Kong'], ['MO', 'Macao'], ['GU', 'Guam'], ['PR', 'Puerto Rico'], ['CK', 'Cook Islands'],
    ['NU', 'Niue'], ['TK', 'Tokelau'], ['WF', 'Wallis and Futuna'], ['PM', 'Saint Pierre and Miquelon'],
    ['GL', 'Greenland'], ['FO', 'Faroe Islands'], ['GI', 'Gibraltar'], ['BM', 'Bermuda'], ['KY', 'Cayman Islands'],
    ['BS', 'Bahamas'], ['TC', 'Turks and Caicos Islands'], ['VG', 'British Virgin Islands'],
    ['VI', 'U.S. Virgin Islands'], ['AI', 'Anguilla'], ['MS', 'Montserrat'], ['SH', 'Saint Helena'],
    ['FK', 'Falkland Islands'], ['GF', 'French Guiana'], ['PF', 'French Polynesia'], ['NC', 'New Caledonia'],
    ['MQ', 'Martinique'], ['GP', 'Guadeloupe'], ['RE', 'Réunion'], ['YT', 'Mayotte'], ['BL', 'Saint Barthélemy'],
    ['MF', 'Saint Martin'], ['SX', 'Sint Maarten'], ['CW', 'Curaçao'], ['AW', 'Aruba'], ['BQ', 'Caribbean Netherlands'],
];
...
export const countries: Country[] = (() => {
    ...
    for (const [code, name] of raw) {
        ...
        seen.add(code);
        list.push({ code, name, flag: toFlag(code) });
    }
    return list.sort((a, b) => {
        if (a.code === 'PW') return -1;
        if (b.code === 'PW') return 1;
